...
@onready var boundary_1: Area2D = $"../boundary1"
@onready var boundary_2: Area2D = $"../boundary2"
...
func _ready() -> void:
	...
	# Connect signals from boundaries to a custom function
	boundary_1.connect("body_entered", Callable(self, "_on_boundary_entered"))
	boundary_2.connect("body_entered", Callable(self, "_on_boundary_entered"))
