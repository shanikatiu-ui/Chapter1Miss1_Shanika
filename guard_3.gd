...
@onready var boundary_5: Area2D = $"../boundary5"
@onready var boundary_6: Area2D = $"../boundary6"
...
func _ready() -> void:
	...
	boundary_5.connect("body_entered", Callable(self, "_on_boundary_entered"))
	boundary_6.connect("body_entered", Callable(self, "_on_boundary_entered"))
